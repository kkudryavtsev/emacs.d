(defun color-theme-dka ()
  "Color theme by Doug Alcorn, created 2009-09-23, based on
Girish Bharadwaj's theme."
  (interactive)
  (color-theme-install
   '(color-theme-bharadwaj
    ...
    (text-cursor ((t (:background "yellow" :foreground "gainsboro"))))
    (toolbar ((t (nil))))
